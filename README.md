...
2. Разделяне на наречията по вид (за място, за време, за начин, за сравнение и т.н.)
3. Автоматично генериране на другите две форми за глаголи от първо и четвърто склонения
4. Разделяне на местоименията на въпросителни, определени и неопределени
5. Вместо (+acc) -> (), (+dat) -> [], (+abl) -> {}, (+gen) -> <>
6. Да се въведат още от думите от LLPSI поредицата
7. Да се въведат всички думи от речника на СУ
