...
3. Разделяне на местоименията на въпросителни, определени и неопределени
4. Вместо (+acc) -> (), (+dat) -> [], (+abl) -> {}, (+gen) -> <>
5. Да се въведат още от думите от LLPSI поредицата
6. Да се въведат всички думи от речника на СУ
